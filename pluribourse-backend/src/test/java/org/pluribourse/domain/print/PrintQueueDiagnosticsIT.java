...
class PrintQueueDiagnosticsIT extends IntegrationTest {
    ...
    private Long createPrinter(String name, String bridgeStatus) throws Exception {
        ...
        return createPrinterWithBridgeId(name, bridgeId, PrinterStatus.valueOf(bridgeStatus));
    }

    private Long createPrinterWithBridgeId(String name, String bridgeId, PrinterStatus status) throws Exception {
        CreatePrinterDto payload = new CreatePrinterDto(name, PrinterType.A4, null, bridgeId, status);
