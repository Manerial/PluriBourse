...
class ItemManagementIT extends IntegrationTest {
    ...
    void setUpSessions() throws Exception {
        ...
        MvcResult editionResult = mockMvc.perform(post("/api/admin/editions")
                        ...
                        .content(objectMapper.writeValueAsString(new EditionDto(null, "Bourse Items 2026", null, null, null, null, false, LocalDate.of(2026, 1, 1), LocalDate.of(2026, 1, 3), null, null))))
