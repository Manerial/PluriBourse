...
import org.pluribourse.item.dto.CreateItemDto;
...
import org.pluribourse.print.service.ThermalLabelRenderer;
...
class ThermalLabelPrintingIT extends IntegrationTest {
    ...
    @Autowired private ThermalLabelRenderer renderer;
    @Autowired private ThermalPrintService thermalPrintService;
    ...
    @Test @Order(14)
    @Transactional(readOnly = true) // read-only, no HTTP writes in this test: safe to keep the session open for lazy access below
